...
const carrot_seed = new Seed("carrot", 20, carrot_plantation.name, carrot.name, 2, 2);

const zucchini_plantation = new Item("zucchini_plantation");
const zucchini = new Items("zucchini");
const zucchini_seed = new Seed("zucchini", 30, zucchini_plantation.name, zucchini.name, 2, 2);

const eggplant_plantation = new Item("eggplant_plantation");
const eggplant = new Items("eggplant");
const eggplant_seed = new Seed("eggplant", 300, eggplant_plantation.name, eggplant.name, 1, 2);
